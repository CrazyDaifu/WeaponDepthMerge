...
- Version: `1.1-rc10`.
- Current test target: isolate the remaining reload crash. After a working depth view exists, the next ReShade effect reload permanently disables merging until process restart.
